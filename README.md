...
- 런칭 대시보드 고속 캐시: Pulse, 유입/전환 보드, proof, 스모크, 워룸, 리캡, 커뮤니티/미디어 키트의 반복 계산을 짧은 TTL 캐시로 줄이고 피드백/성장 이벤트/요금제/추천/실험 쓰기 시 즉시 무효화
...
- `/public/launch-smoke`: 런칭룸, 시장 리포트, 검증 허브, 반박 FAQ, 공유 확산팩, 액션 라우터, 공개 전환 보드, 출시 게이트, 검색/공유 메타, 측정 이벤트를 스모크 체크로 점검
