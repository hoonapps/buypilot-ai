...
- `/public/launch-room`: 데모 갤러리, 공개 시장 리포트, proof strip, 유입 허브, 런칭 반박 FAQ, 공유 확산팩, 런치 Pulse, 추천 대기열, 요금제 관심을 외부 공유용 런칭룸 카드로 집계
