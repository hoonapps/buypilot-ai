...
- GitHub Actions 출시 품질 게이트: 제품 API는 Ruff, pytest, 제품 계획 PDF 렌더, Docker build를 통과해야 하고 웹사이트는 TypeScript/build, production `/launch` 시각 스모크, Docker build를 통과해야 main에 안전하게 반영
